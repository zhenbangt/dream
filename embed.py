...
class InstructionPolicyEmbedder(Embedder):
    ...
    def __init__(self, trajectory_embedder, obs_embedder, instruction_embedder,
        ...
        self._fc_layer =  nn.Linear(obs_embedder.embed_dim + instruction_embedder.embed_dim + self._trajectory_embedder.embed_dim, 256)
    ...
    def forward(self, states, hidden_state):
        ...
        hidden = F.relu(self._fc_layer(torch.cat((obs_embed, instruction_embed, trajectory_embed), -1)))
